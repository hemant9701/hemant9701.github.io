...
module.exports = "\n<nav class=\"navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top\">\n  <div class=\"container\">\n    <a class=\"navbar-brand\" >{{title}}</a>\n    <button class=\"navbar-toggler navbar-toggler-right\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarResponsive\" aria-controls=\"navbarResponsive\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n      <span class=\"navbar-toggler-icon\"></span>\n    </button>\n    <div class=\"collapse navbar-collapse\" id=\"navbarResponsive\">\n      <ul class=\"navbar-nav ml-auto\">\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" [routerLink]=\"['/home']\">Home</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" [routerLink]=\"['/about-us']\">About Us</a>\n        </li>\n        <li class=\"nav-item dropdown\">\n          <a class=\"nav-link dropdown-toggle\" [routerLink]=\"['/blogs']\" id=\"navbarDropdownBlog\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">\n            Blog\n          </a>\n          <div class=\"dropdown-menu dropdown-menu-right\" aria-labelledby=\"navbarDropdownBlog\">\n            <a class=\"dropdown-item\" [routerLink]=\"['/create']\" >Blog Create</a>\n          </div>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" [routerLink]=\"['/contact']\" >Contact</a>\n        </li>\n      </ul>\n    </div>\n  </div>\n</nav>\n\n\n\n<br/>\n\n<router-outlet></router-outlet>\n\n<br/>\n\n\n<footer class=\"py-5 bg-dark\">\n  <div class=\"container\">\n    <p class=\"m-0 text-center text-white\">Copyright &copy; Your Website 2018</p>\n  </div>\n</footer>"
...
//router module used for setting upthe application level route
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                //routerModuler forRoot method to declare the possible routes in application
                _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forRoot([
                    ...
                    { path: 'blogs', component: _blogs_blogs_component__WEBPACK_IMPORTED_MODULE_15__["BlogsComponent"] },
...
module.exports = "\n<div class=\"container\">\n\n  <!-- Page Heading/Breadcrumbs -->\n  <h1 class=\"mt-4 mb-3\">New Blog\n    <small>Create</small>\n  </h1>\n\n  <ol class=\"breadcrumb\">\n    <li class=\"breadcrumb-item\">\n      <a [routerLink]=\"['/home']\">Home</a>\n    </li>\n    <li class=\"breadcrumb-item active\">Create New Blog</li>\n  </ol>\n\n\n  <!-- Contact Form -->\n  <!-- In order to set the email address and subject line for the contact form go to the bin/contact_me.php file. -->\n  <div class=\"row\">\n    <div class=\"col-lg-8 mb-4\">\n      <form #createBlogFrom=\"ngForm\" (ngSubmit)=\"createBlog()\">\n        <div class=\"control-group form-group\">\n          <div class=\"controls\">\n            <label>Blog Title: </label>\n            <input type=\"text\" name=\"blogTitle\" [(ngModel)]=\"blogTitle\" #title=\"ngModel\" class=\"form-control\" id=\"name\" required >\n            <p class=\"help-block\"></p>\n          </div>\n        </div>\n        <div [hidden]=\"title.valid || title.pristine\" class=\"alert alert-danger\">\n          Blog Title is required!\n        </div>\n        <div class=\"control-group form-group\">\n          <div class=\"controls\">\n            <label>Description:</label>\n            <input type=\"text\" name=\"blogDescription\" [(ngModel)]=\"blogDescription\" #description=\"ngModel\" class=\"form-control\" id=\"phone\" required data-validation-required-message=\"Please enter Description.\">\n          </div>\n        </div>\n        <div class=\"control-group form-group\">\n          <div class=\"controls\">\n            <label>Blog Html Body:</label>\n            <textarea rows=\"5\" cols=\"20\" name=\"blogBodyHtml\" [(ngModel)]=\"blogBodyHtml\" #bodyHtml=\"ngModel\"  class=\"form-control\" id=\"message\" required data-validation-required-message=\"Please enter your message\" maxlength=\"999\" style=\"resize:none\"></textarea>\n          </div>\n        </div>\n        <div class=\"control-group form-group\">\n          <div class=\"controls\">\n            <label>Blog Category:</label>\n            <select name=\"blogcategory\" [(ngModel)]=\"blogcategory\" #category=\"ngModel\" class=\"form-control\" id=\"category\" required>\n              <option *ngFor=\"let category of possibleCategories\" [value]=\"category\">{{ category }}</option>\n            </select>\n          </div>\n        </div>\n        <div id=\"success\"></div>\n        <!-- For success/fail messages -->\n        <button type=\"submit\" [disabled]=\"!createBlogFrom.form.valid\" class=\"btn btn-primary\" id=\"sendMessageButton\">Save Blog</button>\n      </form>\n    </div>\n  \n    <!-- Sidebar Widgets Column -->\n    <div class=\"col-md-4\">\n\n      <!-- Search Widget -->\n      <div class=\"card mb-4\">\n        <h5 class=\"card-header\">Search</h5>\n        <div class=\"card-body\">\n          <div class=\"input-group\">\n            <input type=\"text\" class=\"form-control\" placeholder=\"Search for...\">\n            <span class=\"input-group-btn\">\n              <button class=\"btn btn-secondary\" type=\"button\">Go!</button>\n            </span>\n          </div>\n        </div>\n      </div>\n\n      <!-- Categories Widget -->\n      <div class=\"card my-4\">\n        <h5 class=\"card-header\">Categories</h5>\n        <div class=\"card-body\">\n          <div class=\"row\">\n            <div class=\"col-lg-6\">\n              <ul class=\"list-unstyled mb-0\">\n                <li>\n                  <a >Web Design</a>\n                </li>\n                <li>\n                  <a >HTML</a>\n                </li>\n                <li>\n                  <a >Freebies</a>\n                </li>\n              </ul>\n            </div>\n            <div class=\"col-lg-6\">\n              <ul class=\"list-unstyled mb-0\">\n                <li>\n                  <a >JavaScript</a>\n                </li>\n                <li>\n                  <a >CSS</a>\n                </li>\n                <li>\n                  <a >Tutorials</a>\n                </li>\n              </ul>\n            </div>\n          </div>\n        </div>\n      </div>\n\n      <!-- Side Widget -->\n      <div class=\"card my-4\">\n        <h5 class=\"card-header\">Side Widget</h5>\n        <div class=\"card-body\">\n          You can put anything you want inside of these side widgets. They are easy to use, and feature the new Bootstrap 4 card containers!\n        </div>\n      </div>\n\n    </div>\n    \n  <!-- /.row -->\n  </div>\n\n</div>\n<!-- /.container -->\n\n"
...
module.exports = "\n<div class=\"container\">\n\n    <!-- Page Heading/Breadcrumbs -->\n    <h1 class=\"mt-4 mb-3\">Blog\n      <small>Edit</small>\n    </h1>\n  \n    <ol class=\"breadcrumb\">\n      <li class=\"breadcrumb-item\">\n        <a [routerLink]=\"['/home']\">Home</a>\n      </li>\n      <li class=\"breadcrumb-item active\">Edit this Blog</li>\n    </ol>\n  \n  \n    <!-- Contact Form -->\n    <!-- In order to set the email address and subject line for the contact form go to the bin/contact_me.php file. -->\n    <div class=\"row\">\n      <div class=\"col-lg-8 mb-4\">\n        <form #createBlogFrom=\"ngForm\" (ngSubmit)=\"editThisBlog()\">\n          <div class=\"control-group form-group\">\n            <div class=\"controls\">\n              <label>Blog Title: </label>\n              <input type=\"text\" name=\"blogTitle\" [(ngModel)]=\"currentBlog.title\" #title=\"ngModel\" class=\"form-control\" id=\"name\" required >\n              <p class=\"help-block\"></p>\n            </div>\n          </div>\n          <div [hidden]=\"title.valid || title.pristine\" class=\"alert alert-danger\">\n            Blog Title is required!\n          </div>\n          <div class=\"control-group form-group\">\n            <div class=\"controls\">\n              <label>Description:</label>\n              <input type=\"text\" name=\"blogDescription\" [(ngModel)]=\"currentBlog.description\" #description=\"ngModel\" class=\"form-control\" id=\"phone\" required data-validation-required-message=\"Please enter Description.\">\n            </div>\n          </div>\n          <div class=\"control-group form-group\">\n            <div class=\"controls\">\n              <label>Blog Html Body:</label>\n              <textarea rows=\"5\" cols=\"20\" name=\"blogBodyHtml\" [(ngModel)]=\"currentBlog.bodyHtml\" #bodyHtml=\"ngModel\"  class=\"form-control\" id=\"message\" required data-validation-required-message=\"Please enter your message\" maxlength=\"999\" style=\"resize:none\"></textarea>\n            </div>\n          </div>\n          <div class=\"control-group form-group\">\n            <div class=\"controls\">\n              <label>Blog Category:</label>\n              <select name=\"blogcategory\" [(ngModel)]=\"currentBlog.category\" #category=\"ngModel\" class=\"form-control\" id=\"category\" required>\n                <option *ngFor=\"let category of possibleCategories\" [value]=\"category\">{{ category }}</option>\n              </select>\n            </div>\n          </div>\n          <div id=\"success\"></div>\n          <!-- For success/fail messages -->\n          <button type=\"submit\" [disabled]=\"!createBlogFrom.form.valid\" class=\"btn btn-primary\" id=\"sendMessageButton\">Save Blog</button>\n        </form>\n      </div>\n    \n      <!-- Sidebar Widgets Column -->\n      <div class=\"col-md-4\">\n  \n        <!-- Search Widget -->\n        <div class=\"card mb-4\">\n          <h5 class=\"card-header\">Search</h5>\n          <div class=\"card-body\">\n            <div class=\"input-group\">\n              <input type=\"text\" class=\"form-control\" placeholder=\"Search for...\">\n              <span class=\"input-group-btn\">\n                <button class=\"btn btn-secondary\" type=\"button\">Go!</button>\n              </span>\n            </div>\n          </div>\n        </div>\n  \n        <!-- Categories Widget -->\n        <div class=\"card my-4\">\n          <h5 class=\"card-header\">Categories</h5>\n          <div class=\"card-body\">\n            <div class=\"row\">\n              <div class=\"col-lg-6\">\n                <ul class=\"list-unstyled mb-0\">\n                  <li>\n                    <a >Web Design</a>\n                  </li>\n                  <li>\n                    <a >HTML</a>\n                  </li>\n                  <li>\n                    <a >Freebies</a>\n                  </li>\n                </ul>\n              </div>\n              <div class=\"col-lg-6\">\n                <ul class=\"list-unstyled mb-0\">\n                  <li>\n                    <a >JavaScript</a>\n                  </li>\n                  <li>\n                    <a >CSS</a>\n                  </li>\n                  <li>\n                    <a >Tutorials</a>\n                  </li>\n                </ul>\n              </div>\n            </div>\n          </div>\n        </div>\n  \n        <!-- Side Widget -->\n        <div class=\"card my-4\">\n          <h5 class=\"card-header\">Side Widget</h5>\n          <div class=\"card-body\">\n            You can put anything you want inside of these side widgets. They are easy to use, and feature the new Bootstrap 4 card containers!\n          </div>\n        </div>\n  \n      </div>\n      \n    <!-- /.row -->\n    </div>\n  \n  </div>\n  <!-- /.container -->\n    "
...
var BlogEditComponent = /** @class */ (function () {
    function BlogEditComponent(_route, router, blogHttpService, location, toastr) {
        this._route = _route;
        this.router = router;
        this.blogHttpService = blogHttpService;
    ...
    BlogEditComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _blog_http_service__WEBPACK_IMPORTED_MODULE_2__["BlogHttpService"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["Location"], ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"]])
    ], BlogEditComponent);
...
var BlogHttpService = /** @class */ (function () {
    ...
    // methord to get a particular blog only
...
module.exports = "<!-- Page Content -->\r\n<div  >\r\n  <div class=\"container\" *ngIf=\"currentBlog\">\r\n\r\n    <!-- Page Heading/Breadcrumbs -->\r\n    <h1 class=\"mt-4 mb-3\">{{currentBlog.title}}</h1>\r\n\r\n    <ol class=\"breadcrumb\">\r\n      <li class=\"breadcrumb-item\">\r\n        <a>Home</a>\r\n      </li>\r\n      <li class=\"breadcrumb-item active\">Blogs</li>\r\n    </ol>\r\n\r\n    <div class=\"row\">\r\n\r\n      <!-- Post Content Column -->\r\n      <div class=\"col-lg-8\">\r\n\r\n        <!-- Preview Image -->\r\n        <img class=\"img-fluid rounded\" src=\"{{currentBlog.image}}\" alt=\"\">\r\n\r\n        <hr>\r\n\r\n        <!-- Date/Time -->\r\n        <p>Posted on {{currentBlog.create | date}} by {{currentBlog.author}}</p>\r\n\r\n        <hr>\r\n\r\n        <!-- Post Content -->\r\n        <p class=\"lead\">{{currentBlog.description}}</p>\r\n\r\n        <div [innerHtml]=\"currentBlog.bodyHtml\"></div>\r\n\r\n        <p>Category: {{currentBlog.category}}</p>\r\n\r\n        <span *ngIf=\"currentBlog.tags.length!=undefined && currentBlog.tags.length>0\">\r\n            Tags: <a *ngFor=\"let tag of currentBlog.tags;let first=first; let last=last\">\r\n             {{tag}} {{last ? ' ' :', '}}\r\n            </a>\r\n        </span>\r\n\r\n        <div class=\"row\" *ngIf=\"currentBlog\">\r\n          <div class=\"col\">\r\n            <button type=\"button\" [routerLink]=\"['/edit',currentBlog.blogId]\" class=\"btn btn-outline-primary\">Edit</button>\r\n          </div>\r\n          <div class=\"col\"> \r\n            <button type=\"button\" (click)=\"deleteThisBlog()\" class=\"btn btn-outline-danger\">Delete</button>\r\n          </div>\r\n          <div class=\"col\">\r\n            <button type=\"button\" (click)=\"goBackToPreviousPage()\" class=\"btn btn-outline-success\">Go Back</button>\r\n          </div>\r\n        </div>\r\n\r\n        <hr>\r\n\r\n        <!-- Comments Form -->\r\n        <div class=\"card my-4\">\r\n          <h5 class=\"card-header\">Leave a Comment:</h5>\r\n          <div class=\"card-body\">\r\n            <form>\r\n              <div class=\"form-group\">\r\n                <textarea class=\"form-control\" rows=\"3\"></textarea>\r\n              </div>\r\n              <button type=\"submit\" class=\"btn btn-primary\">Submit</button>\r\n            </form>\r\n          </div>\r\n        </div>\r\n\r\n        <!-- Single Comment -->\r\n        <div class=\"media mb-4\">\r\n          <img class=\"d-flex mr-3 rounded-circle\" src=\"http://placehold.it/50x50\" alt=\"\">\r\n          <div class=\"media-body\">\r\n            <h5 class=\"mt-0\">Commenter Name</h5>\r\n            Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.\r\n          </div>\r\n        </div>\r\n\r\n        <!-- Comment with nested comments -->\r\n        <div class=\"media mb-4\">\r\n          <img class=\"d-flex mr-3 rounded-circle\" src=\"http://placehold.it/50x50\" alt=\"\">\r\n          <div class=\"media-body\">\r\n            <h5 class=\"mt-0\">Commenter Name</h5>\r\n            Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.\r\n\r\n            <div class=\"media mt-4\">\r\n              <img class=\"d-flex mr-3 rounded-circle\" src=\"http://placehold.it/50x50\" alt=\"\">\r\n              <div class=\"media-body\">\r\n                <h5 class=\"mt-0\">Commenter Name</h5>\r\n                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.\r\n              </div>\r\n            </div>\r\n\r\n            <div class=\"media mt-4\">\r\n              <img class=\"d-flex mr-3 rounded-circle\" src=\"http://placehold.it/50x50\" alt=\"\">\r\n              <div class=\"media-body\">\r\n                <h5 class=\"mt-0\">Commenter Name</h5>\r\n                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.\r\n              </div>\r\n            </div>\r\n\r\n          </div>\r\n        </div>\r\n\r\n      </div>\r\n\r\n      <!-- Sidebar Widgets Column -->\r\n      <div class=\"col-md-4\">\r\n\r\n        <!-- Search Widget -->\r\n        <div class=\"card mb-4\">\r\n          <h5 class=\"card-header\">Search</h5>\r\n          <div class=\"card-body\">\r\n            <div class=\"input-group\">\r\n              <input type=\"text\" class=\"form-control\" placeholder=\"Search for...\">\r\n              <span class=\"input-group-btn\">\r\n                <button class=\"btn btn-secondary\" type=\"button\">Go!</button>\r\n              </span>\r\n            </div>\r\n          </div>\r\n        </div>\r\n\r\n        <!-- Categories Widget -->\r\n        <div class=\"card my-4\">\r\n          <h5 class=\"card-header\">Categories</h5>\r\n          <div class=\"card-body\">\r\n            <div class=\"row\">\r\n              <div class=\"col-lg-6\">\r\n                <ul class=\"list-unstyled mb-0\">\r\n                  <li>\r\n                    <a >Web Design</a>\r\n                  </li>\r\n                  <li>\r\n                    <a >HTML</a>\r\n                  </li>\r\n                  <li>\r\n                    <a >Freebies</a>\r\n                  </li>\r\n                </ul>\r\n              </div>\r\n              <div class=\"col-lg-6\">\r\n                <ul class=\"list-unstyled mb-0\">\r\n                  <li>\r\n                    <a >JavaScript</a>\r\n                  </li>\r\n                  <li>\r\n                    <a >CSS</a>\r\n                  </li>\r\n                  <li>\r\n                    <a >Tutorials</a>\r\n                  </li>\r\n                </ul>\r\n              </div>\r\n            </div>\r\n          </div>\r\n        </div>\r\n\r\n        <!-- Side Widget -->\r\n        <div class=\"card my-4\">\r\n          <h5 class=\"card-header\">Side Widget</h5>\r\n          <div class=\"card-body\">\r\n            You can put anything you want inside of these side widgets. They are easy to use, and feature the new Bootstrap 4 card containers!\r\n          </div>\r\n        </div>\r\n\r\n      </div>\r\n\r\n    </div>\r\n    <!-- /.row -->\r\n\r\n  </div>\r\n  <!-- /.container -->\r\n</div>"
...
var BlogViewComponent = /** @class */ (function () {
    function BlogViewComponent(_route, router, blogHttpService, location, toastr) {
        this._route = _route;
        this.router = router;
        this.blogHttpService = blogHttpService;
        this.location = location;
    ...
    BlogViewComponent.prototype.ngOnInit = function () {
        ...
        // grtting the blog id from the route
        var myBlogId = this._route.snapshot.paramMap.get('blogId');
        console.log(myBlogId);
        // calling the funtioin to get the blog with this blogId out of the overall
        this.blogHttpService.getSingleBlogInformation(myBlogId).subscribe(function (data) {
            console.log(data);
            _this.currentBlog = data["data"];
        }, function (error) {
    ...
    BlogViewComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _blog_http_service__WEBPACK_IMPORTED_MODULE_2__["BlogHttpService"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["Location"], ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"]])
    ], BlogViewComponent);
...
var BlogService = /** @class */ (function () {
    function BlogService() {
        ...
        this.allBlogs = [
            {
                "blogId": "1",
                "lastModifited": "2018-09-17T15:45:22.854Z",
                "create": "2018-09-17T15:45:22.854Z",
                "tags": [],
                "author": "Hemant",
                "category": "Test",
                "isPublished": true,
                ...
                "description": "this is blog 1 description. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet numquam aspernatur eum quasi sapiente nesciunt? Voluptatibus sit, repellat sequi itaque deserunt, dolores in, nesciunt, illum tempora ex quae? Nihil, dolorem!",
                "title": "This is Blog 1",
                "image": "http://placehold.it/750x300"
            },
            {
                "blogId": "2",
                "lastModifited": "2018-09-17T15:50:45.854Z",
                "create": "2018-09-17T15:50:45.854Z",
                "tags": [],
                "author": "Hemant",
                "category": "Test",
                "isPublished": true,
                "views": 0,
                "bodyHtml": "this is blog body",
                "description": "this is blog 2 description. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet numquam aspernatur eum quasi sapiente nesciunt? Voluptatibus sit, repellat sequi itaque deserunt, dolores in, nesciunt, illum tempora ex quae? Nihil, dolorem!",
                "title": "This is Blog 2",
                "image": "http://placehold.it/750x300"
            },
            {
                "blogId": "3",
                "lastModifited": "2018-09-17T15:55:00.854Z",
                "create": "2018-09-17T15:55:00.854Z",
                "tags": [],
                "author": "Hemant",
                "category": "Test",
                "isPublished": true,
                "views": 0,
                "bodyHtml": "this is blog body",
                "description": "this is blog 3 description. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet numquam aspernatur eum quasi sapiente nesciunt? Voluptatibus sit, repellat sequi itaque deserunt, dolores in, nesciunt, illum tempora ex quae? Nihil, dolorem!",
    ...
    BlogService.prototype.getSingleBlogInformation = function (currentBlogId) {
        // using a for of loop herefrom type script
        // https://www.typescriptlang.org/odcs/handbook/iterators-and-generators.html
...
module.exports = "<div class=\"container\" *ngIf=\"allBlogs.length>0\">\n\n\n  <h1 class=\"mt-4 mb-3\">Blog Home Two\n    <small>Subheading</small>\n  </h1>\n\n  <ol class=\"breadcrumb\">\n    <li class=\"breadcrumb-item\">\n      <a >Home</a>\n    </li>\n    <li class=\"breadcrumb-item active\">Blog</li>\n  </ol>\n\n  <div class=\"row\">\n    <div class=\"col-lg-4\" *ngFor=\"let blog of allBlogs\">\n      <div class=\"card mb-4\">\n        <div class=\"card-body\">\n          <h2 class=\"card-title\">{{blog.title | uppercase}}</h2>\n          <p class=\"card-text\">{{blog.description}}</p>\n          <a class=\"btn btn-primary\" [routerLink]=\"['/blog',blog.blogId]\">Read More &rarr;</a>\n        </div>\n        <div class=\"card-footer text-muted\">\n          Posted on {{blog.created | date }} by {{blog.author}}\n        </div>\n      </div>\n    </div>\n  </div>\n\n\n  <ul class=\"pagination justify-content-center mb-4\">\n    <li class=\"page-item\">\n      <a class=\"page-link\" >&larr; Older</a>\n    </li>\n    <li class=\"page-item disabled\">\n      <a class=\"page-link\" >Newer &rarr;</a>\n    </li>\n  </ul>\n\n</div>\n"
...
var BlogsComponent = /** @class */ (function () {
    function BlogsComponent(blogHttpService) {
        this.blogHttpService = blogHttpService;
        console.log("Blogs component constructor called");
    }
    BlogsComponent.prototype.ngOnInit = function () {
        var _this = this;
        console.log("Blogs component ngOnInit called");
        //gitting the blog id from the route
    ...
    BlogsComponent.prototype.ngOnDestroy = function () {
        console.log("Blogs component ngOnDestroyed");
    };
...
module.exports = __webpack_require__(/*! C:\Users\Hemant\Desktop\Hemant\myDreamApp\src\main.ts */"./src/main.ts");
